...
export const FooterRepository = {
  getFooter: (): FooterModel => {
    return {
      ...
      features: [
        { label: "Kehadiran & Shift", url: "/feature/attendance-shift" },
        { label: "Cuti, Sakit & Izin", url: "/feature/leave-sick-permission" },
        { label: "Manajemen Lembur", url: "/feature/overtime-management" },
        { label: "Data Karyawan", url: "/feature/employee-data" },
        {
          label: "Persetujuan Multilevel Terstruktur",
          url: "/feature/multilevel-approval",
        },
        {
          label: "Struktur Organisasi & Jabatan",
          url: "/feature/org-structure-positions",
        },
        {
          label: "Manajemen Payroll & Pembayaran Gaji",
          url: "/feature/payroll-management",
        },
        { label: "PPH 21 & Pajak", url: "/feature/pph21-tax" },
        {
          label: "Jaminan Sosial & Asuransi",
          url: "/feature/social-security-insurance",
        },
        { label: "Benefit & Tunjangan", url: "/feature/benefits-allowances" },
        {
          label: "Dashboard & Laporan Kinerja",
          url: "/feature/performance-dashboard-reports",
        },
        {
          label: "Aplikasi Mobile Karyawan",
          url: "/feature/employee-mobile-app",
        },
      ],
      resources: [
        { label: "Biaya Berlangganan", url: "/pricing/subscription-pricing" },
